...
| [2dust/v2rayNG](https://github.com/2dust/v2rayNG) | A V2Ray client for Android, support Xray core and v2fly core | Kotlin | 59.5k |
| [termux/termux-app](https://github.com/termux/termux-app) | Termux - a terminal emulator application for Android OS extendible by variety of packages. | Java | 57.6k |
...
| [TeamNewPipe/NewPipe](https://github.com/TeamNewPipe/NewPipe) | A libre lightweight streaming front-end for Android. | Java | 39.0k |
...
| [ImranR98/Obtainium](https://github.com/ImranR98/Obtainium) | Get Android app updates straight from the source. | Dart | 18.2k |
...
| [wailsapp/wails](https://github.com/wailsapp/wails) | Create beautiful applications using Go | Go | 35.2k |
...
| [XIU2/CloudflareSpeedTest](https://github.com/XIU2/CloudflareSpeedTest) | 🌩「自选优选 IP」测试 Cloudflare CDN 延迟和速度，获取最快 IP ！当然也支持其他 CDN / 多个解析 IP 的网站 ~ | Go | 27.9k |
...
| [glebarez/sqlite](https://github.com/glebarez/sqlite) | The pure-Go SQLite driver for GORM | Go | 861 |
...
| [thongtech/go-legacy-win7](https://github.com/thongtech/go-legacy-win7) | Go programming language with Windows 7/8/8.1, Server 2008 R2/2012/2012 R2 support and classic "go get" behaviour | Go | 210 |
...
| [Acode-Foundation/Acode](https://github.com/Acode-Foundation/Acode) | Acode - powerful text/code editor for android | JavaScript | 6.0k |
...
| [rdev/liquid-glass-react](https://github.com/rdev/liquid-glass-react) | Apple's Liquid Glass effect for React | TypeScript | 5.6k |
...
| [android/skills](https://github.com/android/skills) |  | Python | 6.2k |
...
| 仓库 | 简介 | 语言 | ★ |
| --- | --- | --- | ---: |
| [tauri-apps/tauri](https://github.com/tauri-apps/tauri) | Build smaller, faster, and more secure desktop and mobile applications with a web frontend. | Rust | 109.0k |
...
| 仓库 | 简介 | 语言 | ★ |
| --- | --- | --- | ---: |
| [RikkaApps/Shizuku](https://github.com/RikkaApps/Shizuku) | Using system APIs directly with adb/root privileges from normal apps through a Java process started with app_process. | Kotlin | 27.4k |
...
| [TechnitiumSoftware/DnsServer](https://github.com/TechnitiumSoftware/DnsServer) | Technitium DNS Server | C# | 9.2k |
...
| 仓库 | 简介 | 语言 | ★ |
| --- | --- | --- | ---: |
| [louislam/uptime-kuma](https://github.com/louislam/uptime-kuma) | A fancy self-hosted monitoring tool | JavaScript | 89.1k |
...
| [zhuima/awesome-cloudflare](https://github.com/zhuima/awesome-cloudflare) | ⛅️ 精选的 Cloudflare 工具、开源项目、指南、博客和其他资源列表。/ ⛅️ A curated list of Cloudflare tools, open source projects, guides, blogs and other resources. | — | 14.6k |
| [asxez/DockerDesktop-CN](https://github.com/asxez/DockerDesktop-CN) | Docker汉化 Docker中文版 Docker汉化包 DockerDesktop汉化 Docker Windows Docker MAC | — | 9.0k |
