...
| [rivo/tview](https://github.com/rivo/tview) | Terminal UI library with rich, interactive widgets — written in Golang | Go | 14.1k |
| [charmbracelet/lipgloss](https://github.com/charmbracelet/lipgloss) | Style definitions for nice terminal layouts 👄 | Go | 11.8k |
...
| 仓库 | 简介 | 语言 | ★ |
| --- | --- | --- | ---: |
| [FongMi/Release](https://github.com/FongMi/Release) |  | Batchfile | 6.8k |
...
| 仓库 | 简介 | 语言 | ★ |
| --- | --- | --- | ---: |
| [opa334/TrollStore](https://github.com/opa334/TrollStore) | Jailed iOS app that can install IPAs permanently with arbitary entitlements and root helpers because it trolls Apple | Objective-C | 22.1k |
